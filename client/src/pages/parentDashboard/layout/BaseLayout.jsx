...
const BaseLayout = () => {
  return (
    <main className="page-wrapper">
      {/* left of page */}
      <Sidebar />
      <div className="w-20 h-42 bg-transparen fixed bottom-0 right-0 mr-3 my-2 mb-5 animate-bounce overflow-hidden flex items-center justify-center rounded-md cursor-pointer transition-all hover:scale-105" style={{zIndex:"1000"}}>
          <Dialog>
            ...
            <DialogContent className="bg-[#383854] text-white">
              <DialogHeader>
                ...
                <DialogDescription className="h-[80vh] overflow-scroll">
                  <ChatBot endpoint={"/parent"} token={localStorage.getItem("parentToken")}/>
                </DialogDescription>
              </DialogHeader>
            </DialogContent>
          </Dialog>
